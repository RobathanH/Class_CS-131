...
let awksub_test3_correct = filter_reachable (Expr, List.tl (List.tl awksub_rules))
...
let giant_test2 =
  filter_reachable (Sentence, List.tl (List.tl (snd giant_grammar))) =
    (Sentence,
